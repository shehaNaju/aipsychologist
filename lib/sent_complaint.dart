...
//         useMaterial3: true,
//       ),
//       home: const MyComplaintHome(title: 'Sent Complaint'),
//     );
//   }
// }
...
class Send_suggestions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyComplaintHome(title: 'Send complaint'),
    );
  }
}
...
class _MyComplaintHomeState extends State<MyComplaintHome> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: Text('Type your complaint here',)),
  ...
  void sendcompliant() async {
    ...
    final urls = Uri.parse('$url/usersendcomplaint/');
    try {
