...
import 'package:aipsychologist/signup.dart';
...
class _LoginState extends State<LoginNewPage> {
  ...
  _LoginState()
  {
    _controllerUsername.text="manju@gmail.com";
    _controllerPassword.text="1";
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async{
        Navigator.push(context, MaterialPageRoute(builder: (context) =>MyHomePage (title: "Ip Setting"),));
...
// asss
    // final urls=Uri.parse(url+"/caretaker_login/");
    // try{
    //   final response=await http.post(urls,body:{
    //     'username':username,
    //     'password':password,
    ...
    //   }
    //   else {
    //     Fluttertoast.showToast(msg: 'Network Error or invalid username or password');
    //   }
    // }
    // catch (e){
    //   Fluttertoast.showToast(msg: e.toString());
